...
- Persist original source files and validated JSON only. Agents never emit HTML, scripts, styles, layout, navigation, graph coordinates, or UI controls. The renderer turns structured data into one disposable HTML workspace.
